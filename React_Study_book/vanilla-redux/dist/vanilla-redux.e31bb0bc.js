...
var DECREASE = 'DECREASE'; //액션 생선 함수 (액션 이름을 사용하여 액션 객체를 만든다.)

var toogleSwtich = function toogleSwtich() {
  return {
    type: TOGGLE_SWITCH
  };
};

var increase = function increase(diffirence) {
  return {
    type: INCREASE
  };
};
...
var store = (0, _redux.createStore)(reducer); //스토어 내장 함수 사용
...
render(); //구독하기 - 스토어의 상태가 바뀔 때마다 방금 만든 render 함수가 호출되도록
